...
def _build_sam(
    ...
    if checkpoint is not None:
        ...
        # The training is initialized because SAM's weights do not have this module,
        # and the parameters do not match when loaded; Initialized at inference time,
        # but immediately overwritten by the saved arguments.
        # state_dict.setdefault("ME.depthwise_conv_reduce_channels.weight", torch.zeros((256, 48, 1, 1)))
        # state_dict.setdefault("ME.depthwise_conv_reduce_channels.bias", torch.zeros((256)))
